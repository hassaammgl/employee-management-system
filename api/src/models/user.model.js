  ...
  employeeId: {
    ...
    validate: {
      validator: function (v) {
        ...
        if (this.role === "employee" && !v) {
          return false;
        }
        // If role is admin, employeeId should not be present
      ...
      message: function() {
        if (this.role === "employee") {
          return "Employee ID is required when role is employee";
        }
        return "Employee ID should not be provided for admin role";
      }
    }
  },
  refreshToken: {
