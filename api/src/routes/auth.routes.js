...
import { registerSchema, loginSchema, updateUserSchema } from "../validations/auth.validation.js";
import {
	auth
...
router.post("/update-profile", protect, validateRequest(updateUserSchema), auth.updateUserData)
